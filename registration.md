...
- **0.1 Team ★** — team_17 — Steve Rathje (Carnegie Mellon University, srathje@andrew.cmu.edu, ORCID 0000-0001-6727-571X) and Dan-Mircea Mirea (Princeton University, dmirea@princeton.edu, alternate danmirea@sas.upenn.edu, ORCID 0000-0002-4349-7059). This entry's pipeline was built and run by S. Rathje via an automated Claude Code agent; the team's secondary-3/-4/-5 entries use an independent Codex/OpenAI pipeline by D.-M. Mirea.
